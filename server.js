...
function buildPrompt({ notes, pose, garmentAnalysis, seriesPose }) {
  ...
  return [
    ...
    `内搭颜色规则：主商品是浅色（白、米白、浅灰、浅驼、浅粉等）时，内搭用黑色或深棕色。主商品是深色（黑、深灰、深棕等）时，内搭用白色或米色。形成明确的色彩对比，突出主商品。`,
    "内搭款式（如果主商品是外套）：重磅真丝衬衫或极细羊绒打底衫，面料有高级光泽和肌理，半高领或圆领。",
    "下装：黑色或深灰色直筒西裤，羊毛混纺面料，垂坠感极好，裤线锋利，裤长刚好盖住鞋面。",
